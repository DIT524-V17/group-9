...
public class ModeSelection extends AppCompatActivity {
    //Define buttons
    Button btnAto, btnMan, btnFollow;
    String address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ModeSelection.ConnectBT().execute(); //Call the class to connect
                ...
                btnAto = (Button) findViewById(R.id.auto);
                btnMan = (Button) findViewById(R.id.manual);
                btnFollow = (Button) findViewById(R.id.follow);



                // Set Button Action as an id, to connect Ardoino with the GUI
        btnAto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ModeSelection.this, ControlActivity.class));
                setAction("A");

            }
        });
        startActivity(new Intent(ModeSelection.this, CarControl.class));
